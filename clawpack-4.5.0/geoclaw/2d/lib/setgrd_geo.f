...
c
      ...
      logical  vtime, varRefTime
      data     vtime/.false./, varRefTime/.true./
...
c
 ...
 75        continue
             ...
             sp_over_h = getMaxSpeed(alloc(loc),mitot,mjtot,nvar,
...
c
c check that level 1 has a time step that doesn't exceed cfl based on wave speed just calculated
c
         dtc = possk(1)

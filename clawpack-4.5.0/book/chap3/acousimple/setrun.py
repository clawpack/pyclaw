...
The values set in the function setrun are then written out to data files that
will be read in by the Fortran code.
...
#------------------------------
    ...
    if clawdata.outstyle==1:
        ...
        clawdata.tout =  [0.2, 0.8]   # used if outstyle == 2
    ...
    clawdata.cfl_desired = 1.0   # cfl=1 should give exact solution!

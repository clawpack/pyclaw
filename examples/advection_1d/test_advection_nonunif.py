...
def test_1d_advection():
    ...
    classic_tests = gen_variants(advection_1d_nonunif.setup, verify_expected_nonunif(1.156102048093389e-05),
                                 kernel_languages=('Python','Fortran'),
                                 solver_type='classic', outdir=None)

    sharp_tests_rk  = gen_variants(advection_1d_nonunif.setup, verify_expected_nonunif(1.2345173603527554e-07),
                                 kernel_languages=('Python','Fortran'),
                                 solver_type='sharpclaw',time_integrator='SSP104', outdir=None)

    sharp_tests_lmm = gen_variants(advection_1d_nonunif.setup, verify_expected_nonunif(1.712477331998265e-07),
                                 kernel_languages=('Python','Fortran'),
                                 solver_type='sharpclaw',time_integrator='SSPLMMk3', outdir=None)

    weno_tests = gen_variants(advection_1d_nonunif.setup, verify_expected_nonunif(4.014894137206369e-08),

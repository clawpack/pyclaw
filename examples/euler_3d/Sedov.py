...
# Setup Solver
#-----------------------------------------------------------------------
def sedov(kernel_language='Fortran',solver_type='classic',\
          use_petsc=False,outdir='Sedov_3_output',\
          output_format='hdf5',file_prefix='sedov',disable_output=False,\
          mx=256,my=256,mz=256,tfinal=0.10,num_output_times=10):
    ...
    vel_sqrd[:,:,:] = (state.q[1,:,:,:]**2+state.q[2,:,:,:]**2+\

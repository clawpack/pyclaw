...
"""
import pyclaw.clawpack.solver

class ClawSolver1D(pyclaw.clawpack.solver.ClawSolver1D):
    r"""
...
class ClawSolver2D(pyclaw.clawpack.solver.ClawSolver2D):
    r"""
...
class ClawSolver3D(pyclaw.clawpack.solver.ClawSolver3D):
    r"""

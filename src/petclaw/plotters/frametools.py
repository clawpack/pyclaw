...
#==================================================================
    ...
    if (pp_plot_type in ['1d_plot','1d_from_2d_data']) and (pp_plotstyle != ''):
        if pp_color:
    ...
    elif pp_plot_type == '1d_semilogy' and (pp_plotstyle != ''):
        if pp_color:
            pp_kwargs['color'] = pp_color
    ...
    if pp_plot_type == '2d_pcolor':
        ...
        if not var_all_masked:
            if pp_gridlines_show:
                if pp_gridlines_color is None:
                    pp_gridlines_color = 'k'
                pobj = pylab.pcolor(X_edge, Y_edge, var, \
                    cmap=pp_pcolor_cmap, edgecolors=pp_gridlines_color)
            else: 
                pobj = pylab.pcolor(X_edge, Y_edge, var, \
                    cmap=pp_pcolor_cmap, shading='flat')

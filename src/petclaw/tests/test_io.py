...
def test_io_from_hdf5_with_aux():
    regression_dir = os.path.join(thisdir,'./test_data/shock_bubble_interaction_hdf_with_aux')
    read_write_and_compare(file_formats,regression_dir,'hdf5p',0,aux=True)

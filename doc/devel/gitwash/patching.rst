...
Then, send the generated patch files to the `PyClaw
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `PyClaw mailing list`_.
...
Fork the PyClaw_ repository on github |emdash| :ref:`forking`.
Then::

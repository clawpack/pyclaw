# -*- coding: utf-8 -*-
#
# PetClaw documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PetClaw.tex', u'PetClaw Documentation',
   u'David I. Ketcheson, Amal Alghamdi, and Aron Ahmadia', 'manual'),
]
...
man_pages = [
    ('index', 'petclaw', u'PetClaw Documentation',
     [u'David I. Ketcheson, Amal Alghamdi, and Aron Ahmadia'], 1)
]

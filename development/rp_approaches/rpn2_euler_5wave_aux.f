...
c
      if (mbc.gt.3 .or. maxm2 .lt. maxm) then
         write(6,*) 'need to increase maxm2 or 3 in rpn'
         write(6,*) mbc, maxm
         stop
         endif
c
...
c     # find a1 thru a4, the coefficients of the 4 eigenvectors:
      do 20 i = 2-mbc, mx+mbc
         ...
         a3 = aux2(5,i) * (aux2(7,i)*delta(1) 
     &      + aux2(8,i)*delta(2) + aux2(2,i)*delta(3) - delta(4))
         a2 = delta(3) - aux2(2,i)*delta(1)
         a4=(delta(2) + (aux2(4,i)-aux2(8,i))*delta(1)-aux2(4,i)*a3)
     &                 /(2.d0*aux2(4,i))
         a1 = delta(1) - a3 - a4
c
c        # Compute the waves.
...
c        # acoustic:
         wave(1,1,i) = a1
         wave(mu,1,i) = a1*(aux2(8,i)-aux2(4,i))
         wave(mv,1,i) = a1*aux2(2,i)
         wave(4,1,i) = a1*(aux2(3,i) - aux2(8,i)*aux2(4,i))
         wave(5,1,i) = 0.d0
         s(1,i) = aux2(8,i)-aux2(4,i)
c
c        # shear:
         wave(1,2,i) = 0.d0
         wave(mu,2,i) = 0.d0
         wave(mv,2,i) = a2
         wave(4,2,i) = a2*aux2(2,i)
         wave(5,2,i) = 0.d0
         s(2,i) = aux2(8,i)
c
c        # entropy:
         wave(1,3,i) = a3
         wave(mu,3,i) = a3*aux2(8,i)
         wave(mv,3,i) = a3*aux2(2,i)
         wave(4,3,i) = a3*0.5d0*aux2(6,i)
         wave(5,3,i) = 0.d0
         s(3,i) = aux2(8,i)
c
c        # acoustic:
         wave(1,4,i) = a4
         wave(mu,4,i) = a4*(aux2(8,i)+aux2(4,i))
         wave(mv,4,i) = a4*aux2(2,i)
         wave(4,4,i) = a4*(aux2(3,i)+aux2(8,i)*aux2(4,i))
         wave(5,4,i) = 0.d0
         s(4,i) = aux2(8,i)+aux2(4,i)
c

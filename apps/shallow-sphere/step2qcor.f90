...
!     # See the flux2 documentation for more information.
    ...
    external rpn2,rpt2
    double precision :: qold(num_eqn,1-num_ghost:mx+num_ghost, 1-num_ghost:my+num_ghost)
    double precision :: qnew(num_eqn,1-num_ghost:mx+num_ghost, 1-num_ghost:my+num_ghost)
    ...
    double precision :: aux(num_aux, 1-num_ghost:mx+num_ghost, 1-num_ghost:my+num_ghost)

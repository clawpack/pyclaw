...
# encoding: utf-8
"""
stegoton_varyZ_shaheen.py

Run stegoton problem for different values of K, rho in material B.
On Shaheen.
"""
...
if __name__ == "__main__":
    ...
    cellsperlayer=3072; mx=150*cellsperlayer
    ...
    # Controller instantiation
        claw = Controller()
        claw.outdir = './_output'+str(cellsperlayer)
